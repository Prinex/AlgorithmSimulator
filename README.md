...
*  Run the build.sh script file in VS solution explorer -> right click on 'AlgorithmSimulator' project -> select 'Set as Startup Project' -> right-click on 'ALL_BUILD' project -> select 'Build'.  
